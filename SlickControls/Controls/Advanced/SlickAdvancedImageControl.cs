...
{
	public class SlickAdvancedImageControl : SlickImageControl
	{
		...
		protected override void OnPaint(PaintEventArgs e)
		{
			...
			try
			{
				...
				if (ImageHovered)
					e.Graphics.DrawIconsOverImage(ImageBounds, PointToClient(MousePosition), HoverIcons.ToArray());
				...
				e.Graphics.DrawBannersOverImage(this, ImageBounds, Banners);
			}
			catch { }
		}
