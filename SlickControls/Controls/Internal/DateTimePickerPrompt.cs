...
{
	internal partial class DateTimePickerPrompt : Form
	{
		...
		public DateTimePickerPrompt(SlickDateTime dateBox)
		{
			...
			Font = UI.Font(8.25F);
			Size = UI.Scale(new Size(300, 0), UI.FontScale);
			AnimationHandler.Animate(this, UI.Scale(new Size(300, 170), UI.FontScale), 1.4);
			DateBox = dateBox;
			DoubleBuffered = true;
