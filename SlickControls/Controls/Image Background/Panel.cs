	...
	public class SlickImageBackgroundPanel : SlickImageBackgroundControl
	{
		...
		public override void CalculateSize(PaintEventArgs e)
		{
			if (AutoSize && Controls.Count > 0)
			{
				...
				switch (Dock)
				{
					case DockStyle.None: Size = calculatedSize; break;
					case DockStyle.Top: Height = calculatedSize.Height; break;
					case DockStyle.Bottom: Height = calculatedSize.Height; break;
					case DockStyle.Left: Width = calculatedSize.Width; break;
					case DockStyle.Right: Width = calculatedSize.Width; break;
				}
			}
		...
		protected virtual void SetControlBounds(SlickImageBackgroundControl control)
		{
			switch (control.Dock)
			{
				case DockStyle.Top: control.Bounds = new Rectangle(paintPadding.Left, paintPadding.Top, Width - paintPadding.Horizontal, control.Height); break;
				case DockStyle.Left: control.Bounds = new Rectangle(paintPadding.Left, paintPadding.Top, control.Width, Height - paintPadding.Vertical); break;
				case DockStyle.Fill: control.Bounds = new Rectangle(paintPadding.Left, paintPadding.Top, Width - paintPadding.Horizontal, Height - paintPadding.Vertical); break;
				case DockStyle.Bottom: control.Bounds = new Rectangle(paintPadding.Left, Height - paintPadding.Bottom - control.Height - Padding.Top, Width - paintPadding.Horizontal, control.Height); break;
				case DockStyle.Right: control.Bounds = new Rectangle(Width - paintPadding.Right - control.Width - Padding.Left, paintPadding.Top, control.Width, Height - paintPadding.Vertical); break;
			}
		}
		...
		protected virtual void PostControlPaint(SlickImageBackgroundControl control, bool painted)
		{
			switch (control.Dock)
			{
				case DockStyle.Top: paintPadding.Top += control.Height + control.Margin.Vertical; break;
				case DockStyle.Bottom: paintPadding.Bottom += control.Height + control.Margin.Vertical; break;
				case DockStyle.Left: paintPadding.Left += control.Width + control.Margin.Horizontal; break;
				case DockStyle.Right: paintPadding.Right += control.Width + control.Margin.Horizontal; break;
			}
		}

		public override void OnPaint(PaintEventArgs e)
		{
			paintPadding = Padding; paintPadding.Top += scrollY;
