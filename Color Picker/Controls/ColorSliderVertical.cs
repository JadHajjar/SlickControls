...
internal partial class ColorSliderVertical : UserControl
{
	...
	public int Position
	{
		...
		set
		{
			...
			if (num != position)
			{
				...
				ResetHSLRGB();
				Refresh();
				ColorChanged?.Invoke(this, new ColorChangedEventArgs(colorRGB));
			}
		}
	}
	...
	private void DrawSlider(Graphics g)
	{
		...
		var points = new Point[] { new(1, position), new(3, position), new(7, position + 4), new(3, position + 8), new(1, position + 8), new(0, position + 7), new(0, position + 1) };
